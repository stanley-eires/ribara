...
class ArticlesController extends Controller
{
    public function index(Request $request)
    {
        ...
        $data['posts'] = Post::select('id', 'user_id', 'content', 'type', 'created_at')->withCount(['comments', 'likes'])->orderBy('created_at')->paginate();
        return inertia("Admin/Articles/Index", $data);
    }
    ...
    {
        $data['articles'] = [];
        return inertia("Admin/Articles/Form", $data);
    }
