<script setup>
    ...
    let nav = ref([{
        ...
        },
        {
            ...
            active: props.stream == 'network'
        },
        {
            title: "Author Post",
            href: route('feeds', {
                stream: 'author',
                author: usePage().props.auth.user.slug
            }),
            active: props.stream == 'author'
        }
    ])
</script>
                        ...
                        <div class="col-md-9">
                            <div class="card-body w-100">
                                <ul class="text-white list-unstyled fw-bold ">
                                    <li class="d-flex align-items-start"><i class="fas fa-thumbtack fa-rotate-270 text-warning me-3"></i>
                                ...
                                <div class="text-center text-md-start">
                                    <Link :href="route('profile.index', { slug: $page.props.auth.user.slug })" class="btn bg-light btn-sm text-primary rounded-pill"><i class="far fa-user-pen"></i>
                                    Update Profile</Link>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3" style="background:url(/assets/images/register-img.png);background-size:cover;background-repeat:no-repeat;background-position: center center;">
                        </div>
                    </div>
                    <!-- <div class="blur"></div> -->
                </div>
                        ...
                        <div class="d-flex bg-white justify-conent-between align-items-center rounded-4 py-2 px-3 mb-3">
                            <div class="d-flex w-100 align-items-center justify-content-start">
                                ...
                                <ul class="nav nav-pills flex-row">
                                    <li v-for="i in nav" :key="i" class="nav-item" role="presentation" :class="{ 'd-none d-md-block': i.title == 'Author Post' }">
                            ...
                            <button class="btn d-md-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasResponsive"><i class="fa fa-bars fs-5"></i></button>
                        </div>
                        <create-post-form />
                        <template v-if="allposts.length">
                            <post-item :post="i" v-for="i in allposts" :key="i"></post-item>
                            <infinite-loading v-if="next_page_url" distance="50" direction="bottom" @infinite="loadMore" :firstload="true" />
                        </template>
                        <div v-else class="card card-body my-3 d-flex flex-column justify-content-center text-center align-items-center" style="min-height:40vh">
                            <img loading="lazy" src="/assets/images/coming-soon-img.png" alt="" style="width:250px;object-fit:cover">
                            ...
                            <div style="overflow-y: auto;">
                                ...
                                <div class="">
                                    ...
                                    <div class="card-footer bg-transparent">
                                        <Link :href="route('search.people')">View all recommendations <i class="fa fa-arrow-right  ms-2  "></i>
                                        </Link>
                                    </div>
                                </div>
                            </div>
