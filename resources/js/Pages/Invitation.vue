...
watch( () => form.type, ( value ) => {
    ...
    if ( value == 'mentor' ) {
        message.value = `is inviting you to be ${ usepage.auth.user.usermeta.gender == 'Male' ? 'his' : 'her' } mentor on Ribara. ${ usepage.auth.user.usermeta.gender == 'Male' ? 'He' : 'She' } admires your ethics and would like to learn more from you.`
    } else if ( value == 'protege' ) {
        message.value = `wants to be your mentor on Ribara. On this platform, ${ usepage.auth.user.usermeta.gender == 'Male' ? 'he' : 'she' } is able to share ${ usepage.auth.user.usermeta.gender == 'Male' ? 'his' : 'her' } experiences that would help you better in your field.`
    } else if ( value == 'peer' ) {
        message.value = `wants to connect with you on Ribara to inspire each other as you grow in your career.`
    }
